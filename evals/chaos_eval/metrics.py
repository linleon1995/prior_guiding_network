...
if __name__ == '__main__':
    ...
    dicom_dir = os.listdir("/home/user/DISK/data/Jing/data/2015_MICCAI_BTCV/Train_Sets/img/")
    ground_dir.sort()
    dicom_dir.sort()
    seg_dir.sort()
    ...
    for i in range(6):
      ...
      ddd = nib.load("/home/user/DISK/data/Jing/data/2015_MICCAI_BTCV/Train_Sets/img/"+dicom_dir[i]) 
